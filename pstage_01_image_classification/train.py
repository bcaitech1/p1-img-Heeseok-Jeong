...
def train(data_dir, model_dir, args):
    ...
    if args['optimizer'] == 'madgrad':
        ...
        optimizer = adamp.AdamP(model.parameters(), lr=args['lr'])
    else:
    ...
    if args['kfold']:
                ...
                with torch.no_grad():
                    ...
                    for val_batch in val_loader:
                        ...
                        if figure is None:
                            ...
                            figure = grid_image(inputs_np, labels, preds, shuffle = args['dataset'] != "MaskSplitByProfileDataset")
        ...
        # -- data_loader
        train_set, val_set = dataset.split_dataset(args['valid'])
...
def get_params(parser):
    ...
    parser.add_argument('--batch_size', type=int, default=14, help='input batch size for training (default: 14)')
    parser.add_argument('--valid_batch_size', type=int, default=16, help='input batch size for validing (default: 16)')
    parser.add_argument('--model', type=str, default='VGGNet11_BN', help='model type (default: VGGNet11_BN)')
