...
class CustomAugmentation:
    def __init__(self, resize, mean, std, **args):
        self.transform = transforms.Compose([
            CenterCrop((380, 380)),
            # Resize(resize, Image.BILINEAR),진짜 
...
class MaskBaseDataset(data.Dataset):
    ...
    # def __init__(self, data_dir, mean=(0.560, 0.524, 0.501), std=(0.233, 0.243, 0.246), val_ratio=0.2):
    ...
    def split_dataset(self, valid):
        n_val = int(len(self) * self.val_ratio) if valid else 0
...
class TestDataset(data.Dataset):
    ...
    # def __init__(self, img_paths, resize, mean=(0.560, 0.524, 0.501), std=(0.233, 0.243, 0.246)):
